...
#' update_geom_font_defaults(family=font_roboto_bold)
#'
#' count(mpg, class) %>%
#'   ggplot(aes(class, n)) +
#'   geom_col() +
...
theme_roboto <- function(
  ...
  plot_title_family=if (.Platform$OS.type == "windows") "Roboto Regular" else "Roboto Bold",
  plot_title_size = 18,
  plot_title_face="bold",
  plot_title_margin = 10,
  subtitle_family=if (.Platform$OS.type == "windows") "Roboto Regular" else "Roboto Light",
  subtitle_size = 13,
  subtitle_face = "plain", subtitle_margin = 15,
  strip_text_family = base_family, strip_text_size = 12,
  strip_text_face = "plain",
  caption_family=if (.Platform$OS.type == "windows") "Roboto Regular" else "Roboto Light",
  caption_size = 9,
