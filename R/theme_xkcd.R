...
#'
#' You should [import_xkcd]() first and also install the fonts on your
...
#' # seminal bar chart
#'
#' update_geom_font_defaults(family=font_sh)
#'
#' count(mpg, class) %>%
#'   ggplot(aes(class, n)) +
#'   geom_col() +
...
#' }
theme_xkcd <- function(
  base_family="xkcd", base_size = 10.5,
  plot_title_family=if (.Platform$OS.type == "windows") "xkcd" else "xkcd",
  plot_title_size = 18,
  plot_title_face="bold",
  plot_title_margin = 10,
  subtitle_family=if (.Platform$OS.type == "windows") "xkcd" else "xkcd",
  subtitle_size = 12,
  subtitle_face = "plain",
  subtitle_margin = 15,
  ...
  caption_family=if (.Platform$OS.type == "windows") "xkcd" else "xkcd",
  caption_size = 9,
