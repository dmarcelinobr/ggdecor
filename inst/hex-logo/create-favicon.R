...
img <- readPNG("~/ggdecor/inst/doc/palette3.png")
g <- rasterGrob(img, interpolate=TRUE)

flag <- readPNG("~/ggdecor/inst/doc/pantone1.png")
...
ggplot() +
  ...
  geom_polygon(data = hex_poly, aes(x, y), color = high_color, alpha = 0,
    size = 22) +
  annotate("text", x = 0, y = 0.75, label= "ggdecor",
           size = 52, family = "Roboto", fontface="bold") +
  annotation_custom(g, xmin = -1.15, xmax = 1.0, ymin = -1.40, ymax = .85) +
...
png("~/ggdecor/inst/doc/ggdecor-logo.png", width = 905, height = 1050, bg = "transparent")
print(logo)
dev.off()
...
ggplot() +
  ...
  geom_polygon(data = hex_poly, aes(x, y), color = high_color, alpha = 0,
               size =  0.35) +
  annotate("text", x = 0, y = 0.66, label= "ggdecor",
...
png("~/ggdecor/inst/doc/ggdecor-icon.png", width = 32, height = 32, bg = "transparent")
print(icon)
dev.off()
...
png("~/ggdecor/inst/doc/ggdecor-icon-192.png", width = 192, height = 192, bg = "transparent")
print(icon_192)
dev.off()
